...
<table class="table table-striped table-condensed table-hover">
    ...
    <c:forEach items="${data.list}" var="x">
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-success btn-sm" onclick="roomdetails(${x.hName},${x.floorId})">详情</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table class="table" border="0">
                    <tr>
                        <td>房间号：<span id="Id"></span></td>
                    </tr>
                    <tr>
                        <td>房间类型：<span id="count"></span></td>
                    </tr>
                    <tr>
                        <td>单价：<span id="price"></span></td>
                    </tr>
                    <tr>
                        <td>楼层：<span id="lou" ></span></td>
                    </tr>
                    <tr>
                        <td>状态：<span id="sta"></span></td>
                    </tr>
                    <tr>
                        <td>房内设施：<span id="she"></span></td>
                    </tr>
...
<script>
    ...
    //详情
    //打开模态框
    function roomdetails(hName,floorId) {
        //显示模态框
        $("#one").modal("show");
       $("#img").text(hName)
        $("#Id").text(floorId)
